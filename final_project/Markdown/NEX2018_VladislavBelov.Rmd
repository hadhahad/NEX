---
title: "Parameters Grid Search for Random Forest Classifier on Fall Detection Data"
...
cleaned and all of the explanatory variables will be normalized. There will be
multiple training sessions depending on the initial parameters of the Random 
Forest model. This set of parameters will be called the grid of parameters. 
After each training session the prediction accuracy will be evaluated given 
the fixed test set. Aforementioned procedures will provide us with a new dataset
with the parameter grid as explanatory variables and model accuracy as the 
