...
#Data
In this assigment we use a data set "experiment_data". The data give number of dots (number of hits) inside rings with different diameters that a testee was able to draw during 10 seconds. The data were collected from the results of four students. The data set consisting of 36 observations of 4 variables.
...
The goal is to study the influence of a ring size and hand/hands used to perform the experiment on a number of hits. 
...
```
 ...
 According to the R-squared statistic, the model with the ring diameter 
